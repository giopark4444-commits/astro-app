...
// glosario (@aluna/core). Compartido entre /carta, /horoscopo y /hoy — una
// sola fuente de verdad para las excepciones de spelling entre el id interno
// y la clave del glosario (north_node→northnode, exile→detriment,
// whole→wholesign, snake_case→singuiones).
