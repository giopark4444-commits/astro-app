// Lectura base de la carta (ES) por COMPOSICIÓN: planeta (qué vino a vivir) +
// signo (cómo lo expresa) + casa (en qué terreno). ~38 bloques cubren todas las
// combinaciones planeta-en-signo-en-casa. Es el nivel "Esencia"; los tiers
// Profunda/Completa (IA, dormidos hasta la llave) lo tejen bespoke. Voz
// evolutiva-yóguica: propósito del alma, don y sombra.
