// Voz de Aluna para numerología (ES). Evolutivo-yóguico: propósito del alma,
// compasivo pero honesto (nombra la sombra), con una práctica al cierre.
// Este es el nivel "Esencia": hondo pero conciso. Los niveles "Profunda" y
// "Completa" los teje la IA (ver app/api/reading). La traducción vive en
// numerology-en.ts (mismas claves).
